...
async function Options() {
    ...
    document.getElementById("from1").innerHTML = '<option value selected>Choose location</option>'
    document.getElementById("from2").innerHTML = '<option value selected>Choose location</option>'
    document.getElementById("from3").innerHTML = '<option value selected>Choose location</option>'

    document.getElementById("route").innerHTML = '<option value selected>Choose Route</option>'
    ...
    for (const key in response) {
        response[key].forEach(element => {
            for (const key in element) {
                ...
                if (key == "stopList") {
                    element[key].forEach(elementArray => {
